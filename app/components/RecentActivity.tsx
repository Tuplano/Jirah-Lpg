...
export default function RecentActivity({ movements, selectedDate }: RecentActivityProps) {
            ...
            <div key={movement.id} className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-gray-500">
                  Quantity: {movement.quantity} • {new Date(movement.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                </div>
